...
namespace ForceDirectedGraph
{
	...
	public class Diagram
	{
		...
		private const int DEFAULT_SPRING_LENGTH = 450;
		...
		public void Draw(Graphics graphics, Rectangle bounds, double scaleFactor = 1.0)
		{
			...
			// Multiple the natural scale by a factor supplied by the caller to control actual zoom level.
